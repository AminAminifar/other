...
for i = 1:length(data_test1)
    ...
    net1_test1 = w1*i_test1';
    o1u_t1 = max(au.*tanh(bu.*net1_test1),al.*tanh(bl.*net1_test1));
    o1l_t1 = min(au.*tanh(bu.*net1_test1),al.*tanh(bl.*net1_test1));
    
    o1_test1 = (o1u_t1+o1l_t1)/2;
    net2_test1 = w1 * o1_test1';
    o2_test1 = net2_test1;
